...
def lower_capitalized(input):
    ...
    output = output.replace(u"Jose", u"José")
    ...
    output = output.replace(u"Terminal Laranjeiros", u"Terminal Laranjeiras")
    output = output.replace(u"Terminal de Laranjeiras", "Terminal Laranjeiras")
    ...
    output = output.replace(u"C. Detenção Provisória", u"Centro de Detenção Provisória")
