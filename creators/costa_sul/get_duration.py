...
logging.basicConfig(filename="/var/log/GTFS/costa_sul.log", level=logging.DEBUG, format="%(asctime)s %(name)s %(levelname)s - %(message)s", datefmt="%Y/%m/%d %H:%M:%S:")
...
config = {}
with open('costa_sul.json', 'r') as infile:
    config = json.load(infile)

source = {}
with open('../../sources/der-es/costa_sul.json') as infile:
...
durationsList[u"operator"] = u"Costa Sul Transporte e Turismo Ltda"
durationsList[u"network"] = u"Costa Sul"
