...
logging.basicConfig(filename="/var/log/GTFS/lirio.log", level=logging.DEBUG, format="%(asctime)s %(name)s %(levelname)s - %(message)s", datefmt="%Y/%m/%d %H:%M:%S:")
...
config = {}
with open('lirio.json', 'r') as infile:
    config = json.load(infile)

source = {}
with open('../../sources/der-es/lirio.json') as infile:
...
durationsList[u"operator"] = u"Lírio dos Vales Transportes e Fretamento Ltda"
durationsList[u"network"] = u"Lírio dos Vales"
